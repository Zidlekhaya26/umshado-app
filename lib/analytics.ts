...
export type VendorEventType = 'profile_view' | 'save_vendor' | 'quote_requested' | 'message_started' | 'package_view' | 'contact_click' | 'quote_accepted' | 'quote_declined' | 'ad_click' | 'ad_impression';
